...
function useCart() {
    ...
    const updateItem = async (itemId, quantity)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].updateCartItem(itemId, quantity);
            if (response.success) {
                await fetchCart();
            }
            return response;
...
//# sourceMappingURL=src_4934140a._.js.map
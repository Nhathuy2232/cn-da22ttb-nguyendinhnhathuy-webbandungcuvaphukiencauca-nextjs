...
function AdminCategoriesPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            const token = localStorage.getItem("accessToken");
            const url = editingCategory ? "http://localhost:4000/api/admin/categories/".concat(editingCategory.id) : "http://localhost:4000/api/admin/categories";
    ...
    const handleDelete = async (id)=>{
        ...
        try {
            const token = localStorage.getItem("accessToken");
            const response = await fetch("http://localhost:4000/api/admin/categories/".concat(id), {
                method: "DELETE",
                headers: {
                    Authorization: "Bearer ".concat(token)
                }
...
_s(AdminCategoriesPage, "aHLGvl9yq0hhu3cAtHk0y/ol8XE=");
...
//# sourceMappingURL=_c1e409bb._.js.map
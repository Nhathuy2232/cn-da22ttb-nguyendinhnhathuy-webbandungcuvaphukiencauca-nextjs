...
const ghnService_1 = __importDefault(require("../infrastructure/services/ghnService"));
...
router.get('/provinces', async (req, res, next) => {
    try {
        ...
        const result = await ghnService_1.default.getProvinceAsync();
        if (result.success) {
            res.json(result);
        }
        else {
...
router.get('/districts/:provinceId', async (req, res, next) => {
    try {
        ...
        const result = await ghnService_1.default.getDistrictAsync({ provinceId });
        if (result.success) {
            res.json(result);
        }
        else {
...
router.get('/wards/:districtId', async (req, res, next) => {
    try {
        ...
        const result = await ghnService_1.default.getWardAsync({ districtId });
        if (result.success) {
            res.json(result);
        }
        else {
...
router.post('/available-services', async (req, res, next) => {
    try {
        ...
        const result = await ghnService_1.default.getServiceAsync({ fromDistrict: from_district, toDistrict: to_district });
        if (result.success) {
            res.json(result);
        }
        else {
...
router.post('/calculate-fee', async (req, res, next) => {
    try {
        ...
        const result = await ghnService_1.default.calculateFeeAsync({
...
router.post('/leadtime', async (req, res, next) => {
    try {
        ...
        const result = await ghnService_1.default.getLeadTimeAsync({
            fromDistrictId,
            fromWardCode,
            toDistrictId,
            toWardCode,
...
router.post('/create-order', async (req, res, next) => {
    try {
        const result = await ghnService_1.default.createOrderAsync(req.body);
        if (result.success) {
            res.json(result);
        }
        else {
...
router.get('/order/:orderCode', async (req, res, next) => {
    try {
        ...
        const result = await ghnService_1.default.getOrderInfoAsync({ orderCode });
        if (result.success) {
            res.json(result);
        }
        else {
...
router.post('/cancel-order', async (req, res, next) => {
    try {
        ...
        const result = await ghnService_1.default.cancelOrder({ orderCodes: order_codes });
        if (result.success) {
            res.json(result);
        }
        else {
...
router.post('/update-cod', async (req, res, next) => {
    try {
        ...
        const result = await ghnService_1.default.updateCODAsync({
...
router.post('/preview-order', async (req, res, next) => {
    try {
        const result = await ghnService_1.default.previewOrderAsync(req.body);
        if (result.success) {
            res.json(result);
        }
        else {
...
router.get('/pick-shift', async (req, res, next) => {
    try {
        const result = await ghnService_1.default.getPickShiftAsync();
        if (result.success) {
            res.json(result);
        }
        else {
...
router.post('/create-ticket', async (req, res, next) => {
    try {
        ...
        const result = await ghnService_1.default.createTicketAsync({
            orderCode: order_code,
            category,
            description,
            cEmail: c_email,
...
router.post('/order-by-client-code', async (req, res, next) => {
    try {
        ...
        const result = await ghnService_1.default.getOrderByClientCodeAsync(client_order_code);
        if (result.success) {
            res.json(result);
        }
        else {

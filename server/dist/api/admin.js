...
const adminMiddleware_1 = require("../interfaces/http/middlewares/adminMiddleware");
...
router.use(authMiddleware_1.authenticate, adminMiddleware_1.adminMiddleware);
// ============================================
// ADMIN - UPLOAD IMAGE
// ============================================
...
router.post('/upload', upload.single('image'), async (req, res, next) => {
    try {
        ...
        const destPath = path_1.default.join(__dirname, '../../../web/public/images/products', req.file.filename);
